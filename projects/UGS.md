...
<head>
    ...
    <meta charset="UTF-8" />
    <!-- IT department thanks for making me do this...........-->
	<base href = "https://cdn.jsdelivr.net/gh/KingShedew/prodigy-single-file@main/oldprodigy/3-15-3/">
    ...
    <link rel="icon" type="image/png" href="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/css/favicon.png">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/css/font-awesome-bb53ad7bff.min.css">
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/css/main-8920cc59bb.css">
    ...
    <style>
		...
		.login-options-panel {
			border: 41px solid;
			border-image-source: url("https://sso-cdn.prodigygame.com/assets/paper-fe78c9177081028bf4f3948e3da96d36858e5b8d396b563d2254843849e3eedf.png");
		...
		.game-button {
			...
			box-shadow: 0 4px 0 0 rgba(37,21,45,0.5);
			border-radius: 7px;
		...
		.game-button-sapphire {
			background-image: linear-gradient(to bottom, #45a0dd, #4162c0);
			color: white
		}

		.game-button-sapphire .game-button-inner {
			background-image: linear-gradient(to bottom, #4887d5, #45addc)
		}

		.game-button-sapphire:hover {
			background-image: linear-gradient(to bottom, #477cc9, #303c80);
			color: white
		}

		.game-button-sapphire:hover .game-button-inner {
			background-image: linear-gradient(to bottom, #3659ba, #4883cf)
		}

		.game-button-sapphire:active {
			background-image: linear-gradient(to bottom, #4160be, #45abdb)
		}

		.game-button-sapphire:active .game-button-inner {
			background-image: linear-gradient(to bottom, #45b1de, #4886d4)
		}

		.game-button-emerald {
			background-image: linear-gradient(to bottom, #68d376, #236366);
			color: white
		}

		.game-button-emerald .game-button-inner {
			background-image: linear-gradient(to bottom, #1da38a, #5ec38a)
		}

		.game-button-emerald:hover {
			background-image: linear-gradient(to bottom, #1b9885, #174160);
			color: white
		}

		.game-button-emerald:hover .game-button-inner {
			background-image: linear-gradient(to bottom, #266a70, #1d9c88)
		}

		.game-button-emerald:active {
			background-image: linear-gradient(to bottom, #226167, #77d686)
		}

		.game-button-emerald:active .game-button-inner {
			background-image: linear-gradient(to bottom, #66c88a, #1a967d)
		}
		
		.game-button-ruby {
			background-image: linear-gradient(to bottom, #ef6c6e, #ab3a49);
			color: white
		}

		.game-button-ruby .game-button-inner {
			background-image: linear-gradient(to bottom, #dd4658, #f67071)
		}

		.game-button-ruby:hover {
			background-image: linear-gradient(to bottom, #d0445a, #6e2843);
			color: white
		}

		.game-button-ruby:hover .game-button-inner {
			background-image: linear-gradient(to bottom, #ad3e4f, #ee475b)
		}

		.game-button-ruby:active {
			background-image: linear-gradient(to bottom, #a33240, #f86668)
		}

		.game-button-ruby:active .game-button-inner {
			background-image: linear-gradient(to bottom, #f87272, #dc4456)
		}
    </style>
</head>
...
<body>
    ...
    <div id="game-wrapper">
		...
		<div id="login-container" style="
			...
			width: 100%;
		">
			<div id='login-options' class="login-options-panel">
				<button name="button" type="submit" class="game-button game-button-sapphire" onclick="LoadCharacter();">
				  <span class="game-button-inner">Load Character</span>
				</button>
				<button name="button" type="submit" class="game-button game-button-ruby" onclick="OfflineMode();">
				  <span class="game-button-inner">Offline Mode</span>
				</button>
				<button name="button" type="submit" class="game-button game-button-emerald" onclick="NewWizard();">
				  <span class="game-button-inner">New Wizard</span>
				</button>
			</div>
		</div>
    </div>
    ...
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/phaser-e28c61a564.min.js"></script>
    <script src="./js/easystar-0.2.0.min.js"></script>
    <script src="./js/socket.io-1.3.5.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/checkout.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/phasercomponents-d75e07cce7.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/crypto-core-1b15c3f6cc.min.js"></script>
    <script src="https://code.prodigygame.com/lib/crypto-libs-306070295f.min.js?v=1"></script>
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/lz-string.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/stripe-checkout-wrapper.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/inversify-2c041508d4.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/webfont-9ea87c57dc.min.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/Entraptadoeztechnology/old-prodigy@refs/heads/main/oldprodigy/3-15-3/lib/async-f6dfa1eb49.min.js"></script>
	<script>
		window.QI = {};
		window.SW = {};
		SW.LoadIdentity = {
